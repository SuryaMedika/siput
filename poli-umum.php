...
<?php
$id = abs((int)$_GET['id']);
$get = mysql_query("SELECT * FROM pasien WHERE pasien_stage = 'Poli Umum' AND pasien_id='$id'");
...
?>
    ...
    <div class="table">
        <table>
            ...
            <tbody>
            <?php 
            $query = "SELECT * FROM pasien WHERE pasien_stage = 'Poli Umum' ORDER BY pasien_update ASC";
            ...
            ?>
                <tr>
                    <td>
                        <a href="poli-umum.php?aksi=view&id=<?php echo $data['pasien_id']; ?>" class="title">
...
?>
    ...
    <div class="box-">
        <h1>
            Poli Umum <?php echo "&raquo; <strong>".$dataGet['pasien_number']."</strong>"; ?>
        </h1>
    </div>
