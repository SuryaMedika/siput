...
<div class="content">
	...
	<h1>
	    Data Pasien
	    <a href="pasien-baru.php">Tambah Baru</a>
	</h1>
    </div>
	...
	<table>
		...
		<tr>
			...
			<div class="magic-links">
			    <a href="pasien.php?aksi=edit&id=<?php echo $data['pasien_id']; ?>">Edit</a> | <a href="#" class="trash">Trash</a> | <a href="pasien.php?aksi=view&id=<?php echo $data['pasien_id']; ?>">View</a>
			</div>
		    </td>
		    <td class="hide">
			<?php echo $data['pasien_address']; ?><br/>
			<?php echo $data['pasien_desa']; ?>
		    </td>
		    <td class="hide">
	...
	<div class="box">
		...
		<a href="#" class="btn right">Rekam Medis</a>
